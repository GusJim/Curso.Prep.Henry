...
function fizzBuzz(numero) {
  ...
  //*Tomar en cuenta el orden de las operaciones
...
function operadoresLogicos(num1, num2, num3) {
  ...
  //Nota: asegurarse de dejar los  espacios entre el operador  
  //...y los parámetros y valores, ejemplo: num3 === 0, esto permite al interprete
  //reconocer la instrución.
